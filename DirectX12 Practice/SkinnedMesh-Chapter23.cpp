...
/* We will need one SkinnedConstants for each instance of an animated character. An animated character instance will
generally be composed of multiple render-items (one per material), but all render-items for the same character instance can
share the same SkinnedConstants since they all use the same underlying animated skeleton */
...
{
    // Every frame we update the animated character instances
