...
float4 BernsteinBasis(float t)
{
    ...
    return float4(invT * invT * invT, // B0(t) = (1 - t)^3
                   3.0f * t * invT * invT, // B1(t) = 3t(1 - t)^2
                   3.0f * t * t * invT, // B2(t) = 3t^2(1 - t)
                   t * t * t); // B3(t) = t^3
}
...
float4 dBernsteinBasis(float t)
{
    ...
    return float4(-3 * invT * invT, // B0(t) = -3(1 - t)^2
                   3 * invT * invT - 6 * t * invT, // B1(t) = 3(1 - t)^2 - 6(1 - t)
                   6 * t * invT - 3 * t * t, // B2(t) = 6(1 - t) - 3t^2
                   3 * t * t); // B3(t) = 3t^2
}
             ...
             const OutputPatch<HullOut, 16> bezPatch)
{
    ...
    // The above functions can be utilized like so to evaluate p(u, v) and compute the partial derivatives:
