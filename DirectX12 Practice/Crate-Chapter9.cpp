...
//
//		/* Assuming the root signature has been defined to expect a table of shader resource views to be bound to the 0th slot
//		parameter, we can draw our render items with texturing */
...
//
//		cmdList->SetGraphicsRootDescriptorTable(0, tex); // Set up root descriptor table for texture
