...
//{
//	/* The material data is then copied to a subregion of the constant buffer whenever it is changed (“dirty”) so that the GPU
//	material constant buffer data is kept up to date with the system memory material data */
...
//
//	/* The above table stores the material data in system memory. In order for the GPU to access the material data in a shader,
//	we need to mirror the relevant data in a constant buffer */
