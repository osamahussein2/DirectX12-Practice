...
//}
//
///* When the window is resized, we no longer rebuild the projection matrix explicitly, and instead delegate the work to the
//Camera class with SetLens */
...
//
//	/* Before we draw any render-items, we can bind all of our materials and texture SRVs once per frame rather than
//	per-render-item, and then each render-item just sets the object constant buffer */
//
...
//{
//	// Update the root signature based on the new data the shader expects as input
